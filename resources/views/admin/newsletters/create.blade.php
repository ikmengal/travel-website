    ...
    <form id="subscriberForm">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">Create Newsletter Subscriber</h4>
                    <small class="text-muted">Add a new newsletter subscriber.</small>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    {{-- Unsubscribed At --}}
                    <div class="col-md-6 mb-3 unsubscribe-fields d-none">
                    ...
                    <div class="col-md-6 mb-3 unsubscribe-fields d-none">
                        ...
                        <textarea name="unsubscribe_reason" rows="3" class="form-control"></textarea>
...
@endsection
@push('js')
    @include('admin.newsletters.partials.create-script')
@endpush
