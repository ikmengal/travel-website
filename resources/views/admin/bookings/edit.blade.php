...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold">
                <i class="ti ti-edit ti-md me-2 text-primary"></i>
                Edit Booking
            </h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="user_id" name="user_id" class="form-select select2 @error('user_id') is-invalid @enderror">
                                    <option value="">
                                        Select Customer
                                    </option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="tour_id" name="tour_id" class="form-select select2 @error('tour_id') is-invalid @enderror">
                                    <option value="">
                                        Select Tour
                                    </option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="tour_departure_id" name="tour_departure_id" class="form-select select2">
                                    @if($booking->departure)
                                        <option value="{{ $booking->departure->id }}" selected>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $booking->booking_no }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" min="1" id="adults" name="adults"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" min="0" id="children" name="children"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" min="0" id="infants" name="infants"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" id="total_travelers" class="form-control"
                                    value="{{ $booking->total_travelers }}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" id="tour_price" name="tour_price"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" id="grand_total" name="grand_total"
                                        ...
                                        class="form-control fw-bold bg-label-primary" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="booking_status" class="form-select select2 @error('booking_status') is-invalid @enderror">
                                ...
                                <option value="refunded" {{ old('booking_status', $booking->booking_status) == 'refunded' ? 'selected' : '' }}>
                                    Refunded
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="currency" class="form-select select2">
                                <option value="PKR" {{ old('currency', $booking->currency) == 'PKR' ? 'selected' : '' }}>
                                    PKR
                                </option>
