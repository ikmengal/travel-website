<script>
    $(function () {
        ...
        $('#tour_filter').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#departure_filter').html(option).trigger('change');
                },
                error: function () {
        ...
        $(document).on('change', '.booking-checkbox', function () {
            $('#checkAll').prop(
                'checked',
                $('.booking-checkbox').length === $('.booking-checkbox:checked').length
            );
            toggleBulkDeleteButton();
        });
        ...
        function toggleBulkDeleteButton() {
            let checked = $('.booking-checkbox:checked').length;
        ...
        $('#bulkDeleteBtn').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('bookings.bulk-delete') }}",
                        type: "POST",
                        data: {
                            ids: ids
                        },
        ...
        $('#customer_filter, #departure_filter, #booking_status_filter, #payment_status_filter').on('change', function () {
            table.ajax.reload();
        });
