    ...
    <div class="row">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <th>Publish Date</th>
                                <td>{{ optional($blog->published_at)->format('d M Y h:i A') ?? '-' }}</td>
                            </tr>
                            <tr>
                                <th>Tags</th>
                                <td>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label class="fw-semibold d-block mb-1">Meta Title</label>
                        <p class="text-muted mb-0">{{ $blog->meta_title ?: '-' }}</p>
                    </div>
                    <hr>
                    <div>
                        <label class="fw-semibold d-block mb-1">Meta Description</label>
