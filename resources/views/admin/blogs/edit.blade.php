                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea
                                    ...
                                    maxlength="500"
                                    class="form-control"
                                    placeholder="Write short description...">{{ old('short_description', $blog->short_description) }}</textarea>
                                ...
                                <div class="d-flex justify-content-between mt-1">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        <span id="shortDescriptionCount">
                                            {{ strlen(old('short_description', $blog->short_description)) }}
                                        </span>/500
                            ...
                            <div class="d-flex justify-content-between mt-1">
                                ...
                                <small class="text-muted">
                                    ...
                                    <span id="metaTitleCount">
                                        ...
                                        {{ strlen(old('meta_title', $blog->meta_title)) }}
                            ...
                            <div class="d-flex justify-content-between mt-1">
                                ...
                                <small class="text-muted">
                                    ...
                                    <span id="metaDescriptionCount">
                                        ...
                                        {{ strlen(old('meta_description', $blog->meta_description)) }}
