        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-3 mb-3">
                    ...
                    <input type="text" id="search" class="form-control" placeholder="Search title or slug">
                </div>

                {{-- Page Type --}}
                <div class="col-lg-3 mb-3">
                    <label class="form-label">Page Type</label>
                    <select id="page_type_filter" class="form-select select2">
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="pagesDatatable" class="table table table-hover align-middle">
                    <thead>
                        <tr>
                            <th width="40">
