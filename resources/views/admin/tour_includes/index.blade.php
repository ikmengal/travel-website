...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        @can('tour-includes-create')
            <a href="{{ route('tour_includes.create') }}" class="btn btn-primary">
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="container-fluid">
                    <table class="tourIncludeTable table border-top dataTable no-footer dtr-column data_table table-responsive"
                        id="tourIncludeTable" aria-describedby="DataTables_Table_0_info" style="width: 1227px; display:table;">
                        <thead>
                            <tr>
                                <th width="40">
...
@endsection
@push('js')
    @include('admin.tour_includes.scripts')
@endpush
