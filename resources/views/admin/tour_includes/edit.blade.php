...
<form
    action="{{ route('tour_includes.update',$tourInclude->id) }}"
    method="POST"
    id="tourIncludeForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select
                                ...
                                @foreach($tours as $tour)
                                    ...
                                    <option
                                        value="{{ $tour->id }}"
                                        {{ old('tour_id',$tourInclude->tour_id)==$tour->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input
                                type="text"
                                name="title"
                                value="{{ old('title',$tourInclude->title) }}"
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input
                                ...
                                id="icon"
                                name="icon"
                                value="{{ old('icon',$tourInclude->icon) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input
                                type="number"
                                name="sort_order"
                                value="{{ old('sort_order',$tourInclude->sort_order) }}"
                                class="form-control">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check form-switch">
                        ...
                        <input
                            ...
                            {{ old('status',$tourInclude->status) ? 'checked' : '' }}>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a
                            href="{{ route('tour_includes.index') }}"
...
@include('admin.tour_includes.edit_script')
