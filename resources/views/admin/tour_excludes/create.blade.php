...
<form action="{{ route('tour_excludes.store') }}" method="POST" id="tourEccludeForm">
    @csrf
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        {{-- Title --}}
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Exclude Title <span class="text-danger">*</span></label>
                            <input type="text" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Hotel Accommodation">
                            @error('title')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <small class="text-muted">
                                Example: ti ti-home, ti ti-plane, ti ti-map-pin
                            </small>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div id="iconPreview" class="border rounded d-flex align-items-center justify-content-center"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('tour_excludes.index') }}" class="btn btn-outline-secondary">
                            Cancel
                        </a>
                    </div>
                </div>
...
@endsection
@push('js')
    @include('admin.tour_excludes.create-script')
@endpush
