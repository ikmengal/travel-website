...
@section('content')
    ...
    <form action="{{ route('booking_travelers.update', $traveler->id) }}" method="POST" id="travelerForm">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select name="booking_id" id="booking_id"
                                    ...
                                    @foreach($bookings as $booking)
                                        <option value="{{ $booking->id }}" {{ old('booking_id', $traveler->booking_id) == $booking->id ? 'selected' : '' }}>
                                            {{ $booking->booking_no }}
                                            -
                                            {{ $booking->user->name ?? '-' }}
                                        </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select name="gender" class="form-select select2 @error('gender') is-invalid @enderror">
                                    ...
                                    <option value="male" {{ old('gender', $traveler->gender) == 'male' ? 'selected' : '' }}>
                                        Male
                                    </option>
                                    ...
                                    <option value="other" {{ old('gender', $traveler->gender) == 'other' ? 'selected' : '' }}>
                                        Other
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nationality" class="form-control @error('nationality') is-invalid @enderror"
                                    value="{{ old('nationality', $traveler->nationality) }}" placeholder="e.g. Pakistan">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="cnic" class="form-control @error('cnic') is-invalid @enderror"
                                    value="{{ old('cnic', $traveler->cnic) }}" placeholder="xxxxx-xxxxxxx-x">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                    value="{{ old('email', $traveler->email) }}" placeholder="Email Address">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror"
                                    value="{{ old('phone', $traveler->phone) }}" placeholder="Phone Number">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="emergency_contact_name" class="form-control @error('emergency_contact_name') is-invalid @enderror"
                                    value="{{ old('emergency_contact_name', $traveler->emergency_contact_name) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="emergency_contact_phone" class="form-control @error('emergency_contact_phone') is-invalid @enderror"
                                    value="{{ old('emergency_contact_phone', $traveler->emergency_contact_phone) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="address" rows="3" class="form-control @error('address') is-invalid @enderror"
                                    placeholder="Enter Address">{{ old('address', $traveler->address) }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="notes" id="notes" rows="5"
                                    class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $traveler->notes) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" value="1"
                                    {{ old('status', $traveler->status) ? 'checked' : '' }}>
...
@endsection
@push('js')
    @include('admin.booking_travelers.edit-script')
@endpush
