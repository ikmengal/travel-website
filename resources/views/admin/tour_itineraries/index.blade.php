...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        @can('tour-itineraries-create')
            <a href="{{ route('tour_itineraries.create') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" id="search" class="form-control" placeholder="Search itinerary...">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted">
                    Manage day-wise tour itineraries
                </small>
            </div>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="container-fluid">
                    <table class="tourItineraryTable table border-top dataTable no-footer dtr-column data_table table-responsive"
                        id="tourItineraryTable" aria-describedby="DataTables_Table_0_info" style="width: 1227px; display:table;">
                        <thead>
                            <tr>
                                <th width="40">
...
@endsection
@push('js')
    @include('admin.tour_itineraries.scripts')
@endpush
