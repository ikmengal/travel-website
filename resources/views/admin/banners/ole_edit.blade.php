    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                Edit a new homepage banner or slider.
            </p>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subtitle_1" class="form-control"
                                    value="{{ old('subtitle_1', $banner->subtitle_1 ?? '') }}" placeholder="Enter subtitle 1">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subtitle_2" class="form-control"
                                    value="{{ old('subtitle_2', $banner->subtitle_2 ?? '') }}" placeholder="Enter subtitle 2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subtitle_3" class="form-control"
                                    value="{{ old('subtitle_3', $banner->subtitle_3 ?? '') }}" placeholder="Enter subtitle 3">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="description" id="data_description" rows="6"
                                    class="form-control" placeholder="Enter banner description">{{ old('description', $banner->description ?? '') }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="mt-3">
                                    <img id="imagePreview" src="{{ isset($banner->image) && !empty($banner->image) ? asset('images/banners/'.$banner->image) : asset('admin/assets/img/placeholder.jpg') }}"
                                        alt="Preview" class="img-fluid rounded border" style="max-height:220px; display:none;">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="switch switch-warning">
                                    ...
                                    <input type="checkbox" name="featured" value="1"
                                        class="switch-input" {{ old('featured', $banner->featured ?? '') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="switch switch-success">
                                    ...
                                    <input type="checkbox" name="status" value="1"
                                        class="switch-input" {{ old('status', $banner->status ?? '') ? 'checked' : '' }}>
                                    <span class="switch-toggle-slider">
                                        <span class="switch-on">
                                            <i class="ti ti-check"></i>
                                        </span>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" name="meta_title" class="form-control"
                                    value="{{ old('meta_title', $banner->meta_title ?? '') }}" placeholder="Enter meta title">
