                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subtitle_1" class="form-control"
                                    value="{{ old('subtitle_1') }}" placeholder="Enter subtitle_1">
                                <div class="invalid-feedback subtitle_!_error"></div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subtitle_2" class="form-control"
                                    value="{{ old('subtitle_2') }}" placeholder="Enter subtitle_2">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="subtitle_3" class="form-control"
                                    value="{{ old('subtitle_3') }}" placeholder="Enter subtitle_3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="button_text" class="form-control"
                                    value="{{ old('button_text') }}" placeholder="e.g. Book Now">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="description" id="data_description" rows="6"
                                    class="form-control" placeholder="Enter banner description">{{ old('description') }}</textarea>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="mt-3">
                                    <img id="imagePreview" src="{{ asset('admin/assets/img/placeholder.jpg') }}"
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <label class="switch switch-success">
                                    ...
                                    <input type="checkbox" name="status" value="1" class="switch-input"
