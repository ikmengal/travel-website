    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                Update homepage banner or slider.
            </p>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="subtitle_1"
                                    class="form-control"
                                    value="{{ old('subtitle_1', $banner->subtitle_1) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="subtitle_2"
                                    class="form-control"
                                    value="{{ old('subtitle_2', $banner->subtitle_2) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="subtitle_3"
                                    class="form-control"
                                    value="{{ old('subtitle_3', $banner->subtitle_3) }}"
                                    placeholder="Explore">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="avatars_data"
                                    class="form-control"
                                    value="{{ old('avatars_data', $banner->avatars_data) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="card_location"
                                    class="form-control"
                                    value="{{ old('card_location', $banner->card_location) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="card_para"
                                    class="form-control"
                                    value="{{ old('card_para', $banner->card_para) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="card_reviews"
                                    class="form-control"
                                    value="{{ old('card_reviews', $banner->card_reviews) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="tag_icon"
                                    class="form-control"
                                    value="{{ old('tag_icon', $banner->tag_icon) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input
                                    ...
                                    name="tag_heading"
                                    class="form-control"
                                    value="{{ old('tag_heading', $banner->tag_heading) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    class="form-control"
                                    placeholder="We ensure best price for your trips">{{ old('tag_para', $banner->tag_para) }}</textarea>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <label class="switch switch-warning">
                                    ...
                                    <input
                                        ...
                                        value="1"
                                        class="switch-input"
                                        {{ old('featured', $banner->featured) ? 'checked' : '' }}>
