        ...
        <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">
                    ...
                    <a href="{{ route('tour-images.index') }}">
...
<form
    action="{{ route('tour-images.update',$image->id) }}"
    method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea
                                rows="4"
                                name="caption"
                                class="form-control">{{ old('caption',$image->caption) }}</textarea>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a
                            href="{{ route('tour-images.show',$image->id) }}"
                            class="btn btn-info">
