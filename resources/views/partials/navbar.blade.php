                    ...
                    <div class="relative" @click.away="pagesOpen = false">
                        ...
                        <div x-show="pagesOpen"
                             ...
                             @foreach($pagesMenu as $page)
                                <a href="{{ route('main_pages.show',$page->slug) }}" class="block rounded-xl px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:text-blue-600 transition">
                                    {{ $page->title }}
                                </a>
                            @endforeach
                        </div>
